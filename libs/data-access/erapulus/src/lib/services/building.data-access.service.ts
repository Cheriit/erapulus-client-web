...
export class BuildingDataAccessService extends ErapulusDataAccessService {
  ...
  createBuilding (request: BuildingCreateRequestParams): Observable<ErapulusResponse<unknown>> {
    return this.http.post<ErapulusResponse<unknown>>(`${ErapulusDataAccessService.API_URL}/university/${request.universityId}/building`, request);
  }

  getBuilding (request: BuildingGetRequest): Observable<ErapulusResponse<ErapulusBuilding>> {
    return this.http.get<ErapulusResponse<ErapulusBuilding>>(`${ErapulusDataAccessService.API_URL}/university/${request.universityId}/building/${request.buildingId}`);
  }

  editBuilding (request: BuildingEditRequestParams): Observable<ErapulusResponse<unknown>> {
    return this.http.put<ErapulusResponse<unknown>>(`${ErapulusDataAccessService.API_URL}/university/${request.universityId}/building/${request.buildingId}`, request);
  }

  deleteBuilding (request: BuildingDeleteRequestParams): Observable<ErapulusResponse<unknown>> {
    return this.http.delete<ErapulusResponse<unknown>>(`${ErapulusDataAccessService.API_URL}/university/${request.universityId}/building/${request.buildingId}`);
  }
